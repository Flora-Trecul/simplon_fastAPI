...
class User(Base):
    ...
    ls_assoc: Mapped[List["Inscription"]] = relationship(back_populates="user", cascade='all, delete-orphan')
...
class LearningSession(Base):
    ...
    user_assoc : Mapped[List["Inscription"]] = relationship(back_populates="learning_session", cascade='all, delete-orphan')
